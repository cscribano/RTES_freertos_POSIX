...
ros2 run micro_ros_setup build_firmware.sh /project/microros_static_library/library_generation/client-host-toolchain.cmake /project/microros_static_library/library_generation/client-host-colcon.meta
